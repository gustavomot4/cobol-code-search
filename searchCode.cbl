      *================================================================*
      * PROGRAMA  : EDITOR-FONTE-COBOL                                  *
      * DESCRICAO : LE, EXIBE, EDITA E REGRAVA 3 LINHAS DE UM ARQUIVO  *
      * VERSAO    : 3.0 - EVOLUCAO COM SUPORTE A EDICAO DE LINHAS      *
      *                                                                  *
      * ESTRATEGIA DE EDICAO (arquivos sequenciais):                    *
      *   Em COBOL, arquivos LINE SEQUENTIAL nao permitem atualizacao   *
      *   de registros no lugar (in-place). A tecnica correta e:        *
      *                                                                  *
      *   FASE 1 - LEITURA  : Ler o arquivo original e exibir as        *
      *                        3 linhas selecionadas ao usuario.         *
      *   FASE 2 - COLETA   : Receber do usuario o novo conteudo        *
      *                        para cada uma das 3 linhas.              *
      *   FASE 3 - REESCRITA: Ler o original do inicio, gravar cada     *
      *                        linha num arquivo temporario.             *
      *                        Ao encontrar uma linha-alvo, gravar       *
      *                        o novo conteudo no lugar do original.    *
      *   FASE 4 - RENOMEAR : O arquivo temporario se torna o novo      *
      *                        arquivo de saida (ARQUIVO-EDITADO.cbl).  *
      *================================================================*
       IDENTIFICATION DIVISION.
       PROGRAM-ID.   EDITOR-FONTE-COBOL.
      ...
      * --- NOMES DOS ARQUIVOS (ASSIGN dinamico via variavel) ---
      ...
      *     Boas praticas: declarar FILE STATUS para CADA arquivo.
      ...
      *     Altere os valores abaixo para escolher outras linhas.
       01  WS-ALVOS.
      ...
      *                                                                 *
      *  POR QUE ARQUIVO TEMPORARIO?                                    *
      *  Arquivos LINE SEQUENTIAL sao estritamente sequenciais: nao ha  *
      *  como voltar para uma posicao anterior e sobrescrever um        *
      *  registro. A tecnica padrao e:                                  *
      *    1) Abrir original para INPUT e temporario para OUTPUT.       *
      *    2) Copiar linha a linha; ao chegar nas linhas-alvo,          *
      *       gravar a versao nova em vez da original.                  *
      *    3) O temporario se torna o arquivo de saida final.           *
      *================================================================*
       3000-FASE-REESCRITA.
           DISPLAY WS-SEP
